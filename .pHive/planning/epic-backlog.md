...
- **THE BACKLOG IS FULLY DRAINED.** Epics 1-19 are all done. Epic 15 — the actual finish line,
  ...
  "Northline Home Tech," the framework's give-away example). Epic 20 (`promotions-discounts`)
  is **done** as of 2026-09-08 (4/4 stories). Epics 21-23 (bundles, upsell-cross-sell,
