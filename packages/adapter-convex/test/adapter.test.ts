...
import { createConvexAdapter } from "../src/index.js";
import { createFakeConvexClient } from "./fake-client.js";

describe("createConvexAdapter", () => {
  let adapter: Awaited<ReturnType<typeof createConvexAdapter>>;

  beforeEach(async () => {
    adapter = await createConvexAdapter(createFakeConvexClient());
  });
  ...
  describe("skus", () => {
    ...
    it("saves and retrieves a SKU by id, with price reconstructed from the flattened priceAmount/priceCurrency args", async () => {
